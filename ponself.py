...
botStart = time.time() 
cl = LINETCR.LINE() 
cl.login(token="EthNSt4UWZM8mB23Aht5.hHyLIv4Pi25olIZf4pTAHq.1ixfobwh7V8c04S1K4aaDWtIQXtW53U6F6nziaXDnGo=") 
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Et4Io8IBCetMgiNRS0N3.g9hFAHjUSJqeMEJ2LzevSW.RLDRZB+8FdLaWGcd6zAd/0RwXYbRtQruj458CeXFYuo=")

kk = LINETCR.LINE()
kk.login(token="Etzk7kwptiq5YKwwLYtb.lodFQJIdDeu6RojzlceysW.n2rtxh2VZKdW9gL3OriyEvUgIudfpWpFKjFvPZeA6hU=")

kc = LINETCR.LINE()
kc.login(token="Etjz9BkDYZvdzVhUvFt7.OqHiU4EoAi52+lo4wxrUnW.IJtWoGoBTa8GvUaur78QPTMOVzaET2GyH6WBW1s5kjs=")

kd = LINETCR.LINE()
kd.login(token="EtbR3XNIt28r1m4b8YY6.ZnGH4hXTfbbeKHTMA/5f1G.O9yWGdCGGP4Msr+kMYS1sOVOPG1rU/E/S67Mdvxz7GQ=")

botStart = time.time()
ku = LINETCR.LINE()
ku.login(token="EtyOpXwJlG8ZpPDIDmca.9IYF6O/gGbVNy0Di8LdQQG.GXEkTjKZnvQyW8gmTdoofDPS5VW2L6l5f7+uHudKOnA=")

botStart = time.time()
kb = LINETCR.LINE()
kb.login(token="EtjtOj1Ofm5u58xE3pR1.0fmtZ0L0IRzbtmK+abijyq.6kAy9Jd7ZIVVZ+xVU3nbcPbIulUGUEm7GQNvScnmnO0=")

kl = LINETCR.LINE()
kl.login(token="EtQIQ0dg7VSHglFuwSe4.Q7fzw3cF5NaTu/12NDxA1a.kUn+xh4e7CMGdzNBB7sop2jhC7q18gChMk7qq82pKjw=")

botStart = time.time()
kn = LINETCR.LINE()
kn.login(token="EtzBaUET6Frto64MWKca./xh6PlOd/rqzYWT83Fbo6G.hDNlcqtO6rJ9ISCl9z0/RFfJDdAQ7xa6BANzUupsltE=")
kn.loginResult()
...
#=============================== WAIT MESSAGE =================================#
#==============================================================================#
KAC=[cl,ki,kk,kc,kd,ku,kb,kl,kn]
mid = cl.getProfile().mid
Amid = ki.getProfile().mid
Bmid = kk.getProfile().mid
Cmid = kc.getProfile().mid
Dmid = kd.getProfile().mid
Emid = ku.getProfile().mid
Fmid = kb.getProfile().mid
Gmid = kl.getProfile().mid
Nmid = kn.getProfile().mid

Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Nmid]
admin =[mid]
...
message = {
    "replyPesan":"Oit? ,Sarakha Runatha masyana ponakicky ram",
}
...
def myself():
    ...
    Myself =           "╔══[ H E L P   S E L F ]" + "\n" + \
                         ...
                         "╠ " + mykey + "Fbroadcast" + "\n" + \
                         "╠ " + mykey + "Allbroadcast" + "\n" + \
                         "╠ " + mykey + "CheckDate[Text]" + "\n" + \
                         "╠ " + mykey + "Imagesearch[Text]" + "\n" + \
                         "╠ " + mykey + "/Youtube[Text]" + "\n" + \
                         "╠ " + mykey + "Wikipedia[Text]" + "\n" + \
                         "╠ " + mykey + "Musik[Text]" + "\n" + \
                         "╠ " + mykey + "Liric[Text]" + "\n" + \
                         "╠ " + mykey + "Instagram[Text]" + "\n" + \
                         "╚══[ BenhponzCKZ ]"
    return Myself
...
def helptexttospeech():
    ...
    helpTextToSpeech =   "╔══[ T E X T   T O   S P E E C H ]" + "\n" + \
                         ...
                         "╠ " + mykey + "cy : Welsh" + "\n" + \
                         "╚══[ BenhponzCKZ ]" + "\n" + "\n\n" + \
                          "Contoh : " + mykey + "say-id kamu.sange"
    ...
    try:
        ...
        if op.type == 5:
            if wait["autoAdd"] == True:
                ...
                c.contentMetadata = {'mid': "BENHPONZ','"}
                if (wait["message"] in [""," ","\n",None]):
                    pass
                else:
...
#==============================================#
        ...
        if  op.type == 11:
             if op.param2 not in Bots:
                ...
                kk.updateGroup(G)
                kc.updateGroup(G)
                ki.sendContact(op.param1,op.param2)  
                kk.sendContact(op.param1,op.param2) 
                kc.sendContact(op.param1,op.param2)       
        if op.type == 13:
            if mid in op.param3:
                G = cl.getGroup(op.param1)
...
#==============================================================================#
            if msg.contentType == 0:
                ...
                elif "changekey:" in msg.text.lower():
                    sep = msg.text.split(" ")
                    key["keyCommand"] = msg.text.replace(sep[0] + " ","")
                    cl.sendText(msg.to,"Set Key to :「" + str(key["keyCommand"]) + "」")  
...
#==============================================================================#
                elif msg.text.lower() == key["keyCommand"]+'protect on':
                    if wait["protect"] == True:
                        if wait["lang"] == "JP":
                        ...
                        if wait["lang"] == "JP":
                            ...
                            cl.sendText(msg.to,"Protecion Already On")
                elif msg.text.lower() == key["keyCommand"]+'qr on':
                    if wait["linkprotect"] == True:
                        if wait["lang"] == "JP":
                        ...
                        if wait["lang"] == "JP":
                            ...
                            cl.sendText(msg.to,"Protection Qr already On")
                elif msg.text.lower() == key["keyCommand"]+'invite on':
                    if wait["inviteprotect"] == True:
                        ...
                        if wait["lang"] == "JP":
                            ...
                            cl.sendText(msg.to,"ρяσтє¢тισи ιиνιтє αℓ����єα∂у σи")
                elif msg.text.lower() == key["keyCommand"]+'protect off':
                ...
                elif msg.text.lower() == key["keyCommand"]+'qr off':
                    if wait["linkprotect"] == False:
                        ...
                        if wait["lang"] == "JP":
                            ...
                            cl.sendText(msg.to,"Protection Qr already Off")
                elif msg.text.lower() == key["keyCommand"]+'invite off':
                    if wait["inviteprotect"] == False:
                        ...
                        if wait["lang"] == "JP":
                            ...
                            cl.sendText(msg.to,"Protection Invite already Off")
#==============================================================================#
                elif msg.text.lower() == key["keyCommand"]+'stay':
                ...
                elif msg.text.lower() == key["keyCommand"]+'join':
                  if msg.from_ in admin:
					G = cl.getGroup(msg.to)
					info = cl.getGroup(msg.to)
					G.preventJoinByTicket = False
                ...
                elif msg.text.lower() == key["keyCommand"]+'respons':
                  if msg.from_ in admin:
                ...
                elif msg.text.lower() == key["keyCommand"]+'spd':
                    start = time.time()
    ...
    #==============================================================================#
                    ...
                    cl.sendMessage(msg)
#---------------
                elif msg.text.lower() == key["keyCommand"]+'leave':
                  if msg.from_ in admin:
                    if msg.toType == 2:
                       G = cl.getGroup(msg.to)
                    try:
...
#---------------
                elif msg.text.lower() == key["keyCommand"]+'staybye':
                  if msg.from_ in admin:
                    if msg.toType == 2:
                       G = cl.getGroup(msg.to)
                    try:
                        #ki.sendText(msg.to, "Kakak jahat :(")
                        kl.leaveGroup(msg.to)
                        #kk.sendText(msg.to, "Kakak jahat :(")
                        kn.leaveGroup(msg.to)
                        #kd.sendText(msg.to, "Kakak jahat :(")
                    except:
                         pass

                elif msg.text.lower() == key["keyCommand"]+'bye':
                  if msg.from_ in admin:
                    if msg.toType == 2:
                       G = cl.getGroup(msg.to)
                    try:
                        ...
                        #kc.sendText(msg.to, "Kakak jahat :(")
                        kc.leaveGroup(msg.to)
                        #kd.sendText(msg.to, "Kakak jahat :(")
                        kd.leaveGroup(msg.to)
                        #ku.sendText(msg.to, "Kakak jahat :(")
                        ku.leaveGroup(msg.to)
                        #kb.sendText(msg.to, "Kakak jahat :(")
...
#---------------------------------------------
                    ...
                    cl.sendText(msg.to, "berhasil ke {} group".format(str(len(groups))))
                    ...
                    cl.sendText(msg.to, "Berhasil ke {} teman".format(str(len(friends))))
    ...
    #================================ SELF KICKER =================================#
    #==============================================================================#
                elif key["keyCommand"]+"Clear" in msg.text.lower():
                       wait["blacklist"] = {}
                ...
                elif key["keyCommand"]+"listbl" in msg.text.lower():
                    if wait["blacklist"] == {}:
                        ...
                        for i in wait["blacklist"]:
                            ...
                            cl.sendMessage(M)
                elif key["keyCommand"]+"wtf" in msg.text.lower():
                       targets = []
                       mention = eval(msg.contentMetadata["MENTION"])
                       mention["MENTIONEES"] [0] ["M"]
                       for x in mention["MENTIONEES"]:
                    ...
                    if msg.toType == 2:
                        ...
                        for _mid in gMembMids:
                            kd.cancelGroupInvitation(msg.to,[_mid])
                        cl.sendText(msg.to,"I pretended to cancel and canceled")
                elif msg.text.lower() == key["keyCommand"]+'gcancel':
    ...
    #================================ SELF SPECIAL ================================#
    #==============================================================================#
                elif key["keyCommand"]+"/youtube " in msg.text.lower():
                ...
                elif key["keyCommand"]+"liric" in msg.text.lower():
                    sep = msg.text.split(" ")
                    search = msg.text.replace(sep[0] + " ","")
                    try:
                        params = {'songname': search}
                ...
                elif key["keyCommand"]+"musik" in msg.text.lower():
                    sep = msg.text.split(" ")
                    search = msg.text.replace(sep[0] + " ","")
                    try:
                        params = {'songname': search}
                        ...
                        for song in data:
                            ...
                            cl.sendText(msg.to, str(njer))
                elif key["keyCommand"]+"instagram " in msg.text.lower():
                    sep = msg.text.split(" ")
    ...
    #==============================================================================#
                    ...
                    if wait["checkPost"] == True: md+="☞ CheckPost → ✔\n"
                    else: md+="☞ CheckPost → ❌\n"
                    if settings["simiSimi"] == True: md+="☞ Simisimi → ✔\n"
                    else:md+="☞ Simisimi → ❌\n"
                    if wait["protect"] == True: md+="☞ Protect → ✔\n"
                    else: md +="☞ Protect → ❌\n"
                    if wait["linkprotect"] == True: md+="☞ Link → ✔\n"
                    else:md+="☞ Link → ❌\n"
                    if wait["inviteprotect"] == True: md+="☞ Invite → ✔\n"
                    else: md+="☞ Invite → ❌\n"
...
#------------
                ...
                elif msg.text.lower() == key["keyCommand"]+'clearban':
                  if msg.from_ in admin:
                    wait["blacklist"] = {}
                    cl.sendText(msg.to,"clear ban succes")
                elif msg.text.lower() == key["keyCommand"]+'on':
                    wait["protect"] = True
                    wait["linkprotect"] = True
                    wait["inviteprotect"] = True
                    kk.sendText(msg.to,"Sudah Aktif Semua")

                elif msg.text.lower() == key["keyCommand"]+'off':
                    wait["protect"] = False
                    wait["linkprotect"] = False
                    wait["inviteprotect"] = False
                    kk.sendText(msg.to,"Sudah Di Nonaktifkan Semua")
#-------------------
                    ...
                    try:
                        ...
                        cl.sendText(msg.to,"Set to : " + text)
                    except:

...
cl = LINETCR.LINE() 
cl.login(token="EtQPlsxTbxgwFcLLyPBb.UGAzRw4w0t9ARHxquw2v2W.hJkqGIDriMRmnXZAPctqlCcfJ7wK4p2K/P0MV2zb+O8=") 
cl.loginResult()
print "sukses mek"
reload(sys)
...
Bots=["uba0699ad6e16d13f5aae15d0516d95db"]
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["manggil manggil ngepen yhaa?  "]
                     ret_ = "[Auto Respond] \n\n " + random.choice(balas)

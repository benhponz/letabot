...
cl = LINETCR.LINE()
cl.login(token='EtgOW7me511JIDtXLGhc.nFBNWQcfkYmq/t2rOM8KBa.Gl+rGS78sw+N2DJ4LcUN07j8ZLAy1Lnhu4yiNB5xGtg=')
cl.loginResult()

ki = kk = kc = cl 

print "sukses kiker mek"
reload(sys)
...
admin=["u1e1625895e29236e4e2e2cc5e0fb5a85"]
wait = {
    'contact':False,
    'autoJoin':True,

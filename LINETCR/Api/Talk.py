...
#  LA = "IOSIPAD\x097.14.0\x09iPhone_OS\x0910.12.0"
  ...
  def qrLogin(self, callback):
    ...
    qr = self.client.getAuthQrcode(True, "Trisan")
  ...
  def checkMidOnGroup(self, mid, gid):
    group = self.getGroup(gid)
    return True if mid in [mem.mid for mem in group.members + group.invitee] else False

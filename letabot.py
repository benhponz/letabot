...
cl = LINETCR.LINE() 
cl.login(token="EtOTGmJJUSjU7VGqHuT3.UTFldPvAqPSA/v9bAL74KW.6LfBJBEmzFVfA6v92sd34K//AgomPfLptm1CC2xjyAc=") 
cl.loginResult()
print "==================[Login Success]==================="
reload(sys)
...
Bots=["ubad7cb0e955a429b1af95f416a5ef893"]
